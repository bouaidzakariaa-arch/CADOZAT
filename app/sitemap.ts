...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/marche-public`,       lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${base}/rdv`,                 lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
    ...modeles.map(m => ({
