...
const vehicules: Vehicule[] = [
  // ── Transport ──
  {
    nom: 'Pick-up Benne 2m³',
    desc: 'Pick-up avec benne 2m³ sur châssis Isuzu 3,5T — livraisons urbaines et rurales',
    couleur: '#CC0000',
    img: '/images/marche-public/transport/pickup-caisse.jpg',
  },
  {
    nom: 'Camion Caisse',
    desc: 'Transport sécurisé de marchandises — caisse fermée isotherme ou sèche sur Isuzu 3,5T à 7,5T',
    couleur: '#CC0000',
    img: '/images/marche-public/transport/camion-caisse.jpg',
  },
  {
    nom: 'Camion Transport de Viande 3,5T',
    desc: 'Caisse frigorifique homologuée transport de viande sur Isuzu 3,5T',
    couleur: '#CC0000',
  },
  {
    nom: 'Camion Transport de Viande 7,5T',
    desc: 'Caisse frigorifique grande capacité transport de viande sur Isuzu 7,5T',
    couleur: '#CC0000',
  },
  {
    nom: 'Pick-up Caisse Frigo Poulet & Viande',
    desc: 'Pick-up caisse frigorifique pour transport de poulet et viande',
    couleur: '#CC0000',
  },

  // ── BTP ──
  {
    nom: 'Camion Benne 3m³ — Isuzu 3,5T',
    desc: 'Benne basculante 3m³ — transport de matériaux légers, terre et gravats',
    couleur: '#1B2B6B',
    img: '/images/marche-public/btp/camion-benne.jpg',
  },
  {
    nom: 'Camion Benne 6m³ — Isuzu 7,5T',
    desc: 'Benne basculante 6m³ — chantiers de construction et travaux publics',
    couleur: '#1B2B6B',
  },
  {
    nom: 'Camion Benne 10m³ — Isuzu 18T',
    desc: 'Grande benne 10m³ sur porteur 18T — travaux lourds et grands chantiers',
    couleur: '#1B2B6B',
  },
  {
    nom: 'Camion Benne Satellite 3m³',
    desc: 'Benne satellite 3m³ sur Isuzu 3,5T — collecte et tri de matériaux en zone urbaine',
    couleur: '#1B2B6B',
  },
  {
    nom: 'Camion Benne Satellite 5m³',
    desc: "Benne satellite 5m³ sur Isuzu 7,5T — chantiers et zones difficiles d'accès",
    couleur: '#1B2B6B',
  },
  {
    nom: 'Porte-Engin',
    desc: 'Transport de gros engins de chantier — tracteurs, tractopelles, chargeuses',
    couleur: '#1B2B6B',
    img: '/images/marche-public/btp/porte-engin.jpg',
  },
  {
    nom: 'Tractopelle',
    desc: 'Engin polyvalent creusement et chargement sur chantier',
    couleur: '#1B2B6B',
    img: '/images/marche-public/btp/tractopelle.jpg',
  },
  {
    nom: 'Véhicules G.T.P',
    desc: 'Chargeuses, pelles hydrauliques, bulldozers — gros travaux publics et terrassement',
    couleur: '#1B2B6B',
  },

  // ── Citerne ──
  {
    nom: 'Camion Citerne Eau & Lait',
    desc: 'Citerne eau potable ou inox alimentaire lait — de 1T (Pick-up) à 10T (Isuzu 18T)',
    couleur: '#0057A8',
    imgs: [
      '/images/marche-public/citerne/citerne-eau1.jpg',
      '/images/marche-public/citerne/citerne-eau2.png',
      '/images/marche-public/citerne/citerne-eau3.png',
      '/images/marche-public/citerne/citerne-eau4.png',
    ],
  },
  {
    nom: 'Camion Citerne Équipé Distribution',
    desc: "Citerne équipée d'un système de distribution — commune, chantier, site isolé sur Isuzu 3,5T",
    couleur: '#0057A8',
  },
  {
    nom: 'Camion Hydro-Cureur 5m',
    desc: "Hydrocureur haute pression 5m³ pour curage de réseaux d'assainissement sur Isuzu 7,5T",
    couleur: '#0057A8',
  },
  {
    nom: 'Aspiratrice 1000L / 6000L / 10000L',
    desc: 'Camion aspirateur pour vidange fosses septiques, curage et aspiration de boues',
    couleur: '#0057A8',
  },
  {
    nom: 'Camion Ampli-Rolo 5T',
    desc: 'Amplirolo citerne 5T sur Isuzu 7,5T — collecte et transport de liquides industriels',
    couleur: '#0057A8',
  },
  {
    nom: 'Camion Ampli-Rolo 10T',
    desc: 'Amplirolo citerne 10T sur Isuzu 16T — grandes capacités de transport de liquides',
    couleur: '#0057A8',
  },

  // ── Environnement ──
  {
    nom: 'Camion Benne Tasseuse',
    desc: 'Collecte et compactage des ordures ménagères — 7m³ à 14m³ sur Isuzu 7,5T à 16T',
    couleur: '#2D6A4F',
    imgs: [
      '/images/marche-public/environnement/benne-tasseuse1.jpg',
      '/images/marche-public/environnement/benne-tasseuse2.png',
      '/images/marche-public/environnement/benne-tasseuse3.jpeg',
      '/images/marche-public/environnement/benne-tasseuse4.jpg',
    ],
  },
  {
    nom: 'Camion Multi-Benne',
    desc: 'Collecte sélective et transport de bennes amovibles',
    couleur: '#2D6A4F',
    imgs: [
      '/images/marche-public/environnement/multi-benne.jpg',
      '/images/marche-public/environnement/multi-benne2.jpg',
      '/images/marche-public/environnement/multi-benne3.jpg',
    ],
  },
  {
    nom: 'Camion Nacelle',
    desc: 'Travaux en hauteur — nacelle 10m ou 16m pour éclairage public, émondage, maintenance',
    couleur: '#2D6A4F',
    imgs: [
      '/images/marche-public/environnement/nacelle.jpg',
      '/images/marche-public/environnement/nacelle1.jpg',
      '/images/marche-public/environnement/nacelle2.jpg',
      '/images/marche-public/environnement/nacelle3.png',
    ],
  },
  {
    nom: 'Camion Balayeur 5m',
    desc: 'Balayeuse mécanique 5m³ sur Isuzu 7,5T — nettoiement des voiries urbaines et rurales',
    couleur: '#2D6A4F',
  },
  {
    nom: 'Véhicule Ramassage Chiens Errants',
    desc: 'Véhicule municipal spécialisé pour la capture et le transport des animaux errants',
    couleur: '#2D6A4F',
  },
]
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-end pt-4"
          style={{ borderTop: `1px solid ${v.couleur}15` }}>
          <div className="w-7 h-7 rounded-full flex items-center justify-center"
            style={{ background: v.couleur + '12' }}>
    ...
    <main className="bg-white">
      ...
      <section className="relative overflow-hidden" style={{ background: '#f7f8fc', paddingTop: '110px', paddingBottom: '0' }}>
        ...
        <div style={{ position:'absolute', inset:0, zIndex:0, opacity:0.5,
          backgroundImage:'radial-gradient(circle, rgba(27,43,107,0.08) 1px, transparent 1px)',
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-end pb-16">
            ...
            <div>
              ...
              <div className="h-in-1 inline-flex items-center gap-2 px-4 py-2 rounded-full mb-7"
                ...
                <span className="text-xs font-black uppercase tracking-widest" style={{ color:'#1B2B6B' }}>
              ...
              <div className="h-in-2 mb-5">
                ...
                <h1 style={{ fontSize:'clamp(48px,7vw,82px)', fontWeight:900, lineHeight:0.95, letterSpacing:'-1.5px', color:'#0f172a', margin:0 }}>
                  Marché
                </h1>
                <h1 style={{ fontSize:'clamp(48px,7vw,82px)', fontWeight:900, lineHeight:0.95, letterSpacing:'-1.5px', margin:0 }}>
                  <span style={{ background:'linear-gradient(90deg, #CC0000 0%, #1B2B6B 100%)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent' }}>
                    Public
                  </span>
                </h1>
              </div>
