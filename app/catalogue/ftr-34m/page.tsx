      ...
      <section className="bg-white pt-32 pb-16 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-8 flex-wrap">
            ...
            <span>/</span>
            <span className="text-[#CC0000] font-semibold">FTR 34M 16T</span>
          </div>
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-2 mb-5 flex-wrap">
                ...
                <span className="bg-gray-100 text-gray-600 text-xs font-semibold px-3 py-1 rounded-full">Châssis intermédiaire</span>
              </div>
              <h1 className="text-5xl lg:text-6xl font-black text-gray-900 mb-2 leading-none">
                FTR <span className="text-[#CC0000]">34M</span>
              </h1>
              <p className="text-gray-400 text-lg font-semibold mb-5">16T — Châssis intermédiaire</p>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-1 bg-[#CC0000] rounded-full" />
                <div className="w-5 h-1 bg-[#C9A84C] rounded-full" />
              </div>
              <p className="text-gray-500 text-base leading-relaxed mb-8 max-w-lg">
                Le FTR 34M offre un empattement intermédiaire de 4 650 mm avec une carosserie de 6 mètres, idéal pour les citernes, bennes ou fourgons de grande capacité. Double réservoir 400 litres.
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <h2 className="text-3xl font-black text-gray-900">Photos du FTR 34M</h2>
              <div className="h-px w-10 bg-[#C9A84C]" />
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { code: 'PTAC', valeur: '16 000', label: 'Poids total' },
              { code: 'EMP',  valeur: '4 650', label: 'Empattement' },
              { code: 'CAR',  valeur: '6 000', label: 'Long. carossable' },
