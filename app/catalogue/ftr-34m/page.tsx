...
const images = [
  ...
  '/images/camions/serie-f/ftr-34m/img3.jpg',
  '/images/camions/serie-f/ftr-34m/img4.jpg',
  '/images/camions/serie-f/ftr-34m/img5.jpg',
  '/images/camions/serie-f/ftr-34m/img6.jpg',
]
  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative bg-[#1B2B6B] py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <span>/</span>
            <span className="text-[#C9A84C] font-semibold">FTR 34M 16T</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl font-black text-white mb-1">
                FTR <span className="text-[#CC0000]">34M</span>
              </h1>
              <p className="text-white/50 text-lg font-semibold mb-4">16T — Grand empattement</p>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-1 bg-[#CC0000] rounded-full" />
                <div className="w-6 h-1 bg-[#C9A84C] rounded-full" />
              </div>
              <p className="text-white/70 text-lg leading-relaxed mb-8">
                Le FTR 34M est la version grand empattement du FTR 16T, offrant une longueur
                carossable de 6 000 mm pour les charges volumineuses. Idéal pour les camions-citernes,
                les carrosseries frigorifiques et les bennes longues. Équipé du puissant moteur
                6HK1-TCN avec double réservoir 200+200 litres pour les longs trajets.
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3 mt-3">
              ...
              <h2 className="text-3xl font-black text-[#1B2B6B]">Photos du FTR 34M</h2>
              <div className="h-px w-12 bg-[#C9A84C]" />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {images.map((src, i) => (
              <div key={i} className="aspect-video rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all bg-gradient-to-br from-[#1B2B6B] to-[#CC0000]">
                <img src={src} alt={`FTR 34M — Photo ${i + 1}`} className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"/>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 bg-gray-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-center text-sm font-bold text-gray-400 uppercase tracking-widest mb-6">Autres modèles F-Series</p>
          <div className="flex flex-wrap gap-3 justify-center">
            {modeles_fseries.map((m) => (
              <Link key={m.nom} href={m.href}
                className={`px-5 py-2.5 rounded-full text-sm font-bold transition-all ${
                  m.actif ? 'bg-[#CC0000] text-white shadow-md' : 'bg-white border-2 border-gray-200 text-gray-600 hover:border-[#CC0000] hover:text-[#CC0000]'
                }`}>
                {m.nom}
              </Link>
            ))}
      ...
      <BrochureForm modele="FTR34M" marque="isuzu" nomModele="FTR 34M" />
      ...
      <section className="py-16 bg-[#1B2B6B] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-white mb-2">
            Intéressé par le <span className="text-[#CC0000]">FTR 34M</span> ?
          </h2>
