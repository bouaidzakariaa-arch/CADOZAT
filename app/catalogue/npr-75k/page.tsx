...
const specs = [
  {
    ...
    items: [
      ...
      { label: 'Poids total en charge (PTAC)', valeur: '7 500 kg' },
...
export default function NPR75KPage() {
  return (
    <main className="bg-white">
      <section className="relative bg-[#1B2B6B] py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <span className="text-[#C9A84C] font-semibold">NPR 75K</span>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4 flex-wrap">
                ...
                <span className="bg-[#C9A84C] text-white text-xs font-bold px-3 py-1 rounded-full">7.5T</span>
              ...
              <h1 className="text-5xl lg:text-6xl font-black text-white mb-1">NPR <span className="text-[#CC0000]">75K</span></h1>
              <p className="text-white/50 text-lg font-semibold mb-4">7.5T — Châssis court</p>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-1 bg-[#CC0000] rounded-full"></div>
                <div className="w-6 h-1 bg-[#C9A84C] rounded-full"></div>
              </div>
              <p className="text-white/70 text-lg leading-relaxed mb-8">
                Le NPR 75K est un camion moyen 7.5T sur châssis court. Moteur 4HK1-TCN
                de 155 ch avec boîte 6 rapports, cabine large confortable. Idéal pour
                la distribution régionale et les travaux de chantier.
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3 mt-3">
              ...
              <h2 className="text-3xl font-black text-[#1B2B6B]">Photos du NPR 75K</h2>
              <div className="h-px w-12 bg-[#C9A84C]"></div>
            </div>
          </div>
      ...
      <BrochureForm modele="npr-75kl" marque="isuzu" nomModele="NPR 75K" />
      <section className="py-16 bg-[#1B2B6B] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-white mb-2">Intéressé par le <span className="text-[#CC0000]">NPR 75K</span> ?</h2>
