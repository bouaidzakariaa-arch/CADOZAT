...
function GaleriePhotos() {
  ...
  const photos = {
    exterieur: [
      { src: '/images/karry/img1.jpg', alt: 'Karry Q22B — Vue avant' },
      { src: '/images/karry/img2.jpg', alt: 'Karry Q22B — Vue côté' },
      { src: '/images/karry/karry22b.jpg', alt: 'Karry Q22B — Plateau' },
    ],
    interieur: [
      { src: '/images/karry/img3.jpeg', alt: 'Karry Q22B — Intérieur' },
      { src: '/images/karry/img4.jpg', alt: 'Karry Q22B — Tableau de bord' },
      { src: '/images/karry/img5.jpg', alt: 'Karry Q22B — Habitacle' },
    ],
  }
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex gap-1 p-1 rounded-xl" style={{ background: '#f0f4f8' }}>
            {(['exterieur', 'interieur'] as const).map(o => (
              <button
                ...
                style={{
                  background: onglet === o ? '#0057A8' : 'transparent',
                  color: onglet === o ? 'white' : '#6b7280',
                  boxShadow: onglet === o ? '0 4px 12px rgba(0,87,168,0.25)' : 'none',
                }}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_180px] gap-4">
          ...
          >
            <img
              src={current[activeIdx].src}
              alt={current[activeIdx].alt}
          ...
          {current.map((_, i) => (
            <button
              ...
              style={{
                ...
                height: '8px',
                background: activeIdx === i ? '#0057A8' : '#d1d5db',
              }}
            />
          ))}
        </div>
        ...
        {lightbox && (
          ...
          >
            <button
              className="absolute top-6 right-6 w-11 h-11 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center text-white transition-all"
              onClick={() => setLightbox(null)}
            >
...
const modele = {
  nom: 'Karry Q22B',
  tag: 'Fourgon Plateau Court',
  soustitre: 'Votre solution idéale de transport en milieu urbain',
  couleur: '#0057A8',
  couleurLight: '#e8f2ff',
  img: '/images/karry/karry22b.jpg',
  ptac: '2 205 kg',
  chargeUtile: '1 100 kg',
  plateau: '2 500 mm',
  specs: {
    moteur: [
      { label: 'Moteur', value: '1.1L — 4 Cylindres' },
      { label: 'Carburant', value: 'Essence' },
      { label: 'Cylindrée', value: '1 083 cm³' },
      { label: 'Puissance', value: '68 Ch' },
      { label: 'Puissance fiscale', value: '6 CV' },
      { label: 'Transmission', value: '5 MT (Manuelle)' },
      { label: 'Couple', value: '98 Nm' },
      { label: 'Vitesse max', value: '110 km/h' },
    ],
    dimensions: [
      { label: 'Dimensions (L×l×h)', value: '4 379 × 1 603 × 1 894 mm' },
      { label: 'Plateau (L×l×h)', value: '2 500 × 1 520 × 370 mm' },
      { label: 'Empattement', value: '2 600 mm' },
      { label: 'PTAC', value: '2 205 kg' },
      { label: 'Poids à vide', value: '1 105 kg' },
      { label: 'Charge utile', value: '1 100 kg' },
    ],
    equipements: [
  ...
  atouts: [
    { icon: '🏙️', titre: 'Idéal en ville', desc: 'Compact et maniable pour la livraison urbaine quotidienne' },
    { icon: '💪', titre: '1 100 kg utile', desc: 'Capacité de charge maximale pour votre activité' },
    { icon: '⛽', titre: 'Économique', desc: 'Moteur 1.1L essence sobre et fiable' },
    { icon: '🛡️', titre: 'ABS + EBD', desc: 'Sécurité active de série sur chaque modèle' },
  ],
}

export default function KarryQ22BPage() {
    ...
    <main className="bg-white min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-10">
                {[
                  ...
                  { val: '2 500', unit: 'mm', label: 'Plateau' },
                  { val: '68', unit: 'Ch', label: 'Puissance' },
                ].map((s, i) => (
            ...
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 bg-white rounded-2xl px-5 py-3 shadow-xl text-center">
                <div className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">PTAC jusqu'à</div>
                <div className="font-black text-2xl leading-none" style={{ color: '#0057A8' }}>1 100<span className="text-sm">kg</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-xs font-black uppercase tracking-widest mb-2" style={{ color: '#0057A8' }}>Pourquoi choisir le Q22B</p>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="rounded-3xl p-10 border-2 border-dashed flex flex-col items-center gap-4" style={{ borderColor: '#0057A820', background: '#f0f6ff' }}>
            ...
            <div className="flex gap-6 text-center">
              {[['Longueur', '2 500 mm'], ['Largeur', '1 520 mm'], ['Hauteur ridelles', '370 mm']].map(([l, v]) => (
                <div key={l}>
      ...
      <section className="py-20" style={{ background: 'linear-gradient(135deg, #0057A8, #003d78)' }}>
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-white/50 text-sm mb-10">Notre équipe vous répond dans les 24h dans nos agences de Ouarzazate, Agadir et Tinghir.</p>
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Link href="/catalogue/karry-22q" className="inline-flex items-center gap-2 text-white font-bold px-8 py-3.5 rounded-xl border border-white/25 hover:bg-white/10 transition-all text-sm">
              Voir le Q22Q (plateau long)
            </Link>
          </div>
        </div>
      </section>
