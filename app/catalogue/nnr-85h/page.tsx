...
const images = [
  ...
  '/images/camions/serie-n/nnr-85h/img3.jpg',
  '/images/camions/serie-n/nnr-85h/img4.jpg',
  '/images/camions/serie-n/nnr-85h/img5.jpg',
  '/images/camions/serie-n/nnr-85h/img6.jpg',
]
      ...
      <section className="bg-white pt-32 pb-16 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-8 flex-wrap">
            ...
            <span>/</span>
            <span className="text-[#CC0000] font-semibold">NNR 85H 3.5T</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-2 mb-5 flex-wrap">
                ...
                <span className="bg-gray-100 text-gray-600 text-xs font-semibold px-3 py-1 rounded-full">Châssis long — Cabine Large</span>
              </div>
              <h1 className="text-5xl lg:text-6xl font-black text-gray-900 mb-2 leading-none">
                NNR <span className="text-[#CC0000]">85H</span>
              </h1>
              <p className="text-gray-400 text-lg font-semibold mb-5">3.5T — Châssis long — Cabine Large</p>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-1 bg-[#CC0000] rounded-full" />
                <div className="w-5 h-1 bg-[#C9A84C] rounded-full" />
              </div>
              <p className="text-gray-500 text-base leading-relaxed mb-8 max-w-lg">
                Le NNR 85H est un camion léger 3.5T sur châssis long avec cabine large, offrant plus de confort pour le conducteur et une grande capacité de chargement. Boîte 6 rapports pour des performances optimales sur route.
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <h2 className="text-3xl font-black text-gray-900">Photos du NNR 85H</h2>
              <div className="h-px w-10 bg-[#C9A84C]" />
            </div>
          </div>
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-gray-900 mb-2">
            Intéressé par le <span className="text-[#CC0000]">NNR 85H</span> ?
          </h2>
