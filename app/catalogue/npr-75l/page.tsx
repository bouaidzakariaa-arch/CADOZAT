...
const specs = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Réservoir", valeur: "100 litres" },
...
export default function NPR75LPage() {
  return (
    <main className="bg-white">
      <section className="relative bg-[#1B2B6B] py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <span className="text-[#C9A84C] font-semibold">NPR 75L</span>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-white/50 text-lg font-semibold mb-4">7.5T — Châssis long</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { icon: '⚡', label: 'Puissance', valeur: '155 ch (114 kw) / 2 600 tr/min' },
                { icon: '🔄', label: 'Couple maxi', valeur: '419 Nm / 1 600 tr/min' },
                { icon: '📦', label: 'PTAC', valeur: '7 500 kg' },
                { icon: '📏', label: 'Cylindrée', valeur: '5 193 cc' },
                { icon: '🛢️', label: 'Réservoir', valeur: '100 litres' },
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3 mt-3">
              ...
              <h2 className="text-3xl font-black text-[#1B2B6B]">Photos du NPR 75L</h2>
              <div className="h-px w-12 bg-[#C9A84C]"></div>
            </div>
          </div>
      ...
      <BrochureForm modele="npr-75ll" marque="isuzu" nomModele="NPR 75L"/>
      <section className="py-16 bg-[#1B2B6B] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-white mb-2">Intéressé par le <span className="text-[#CC0000]">NPR 75L</span> ?</h2>
