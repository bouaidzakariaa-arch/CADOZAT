...
export const metadata = {
  title: 'FVR 34K 18T — Camion Isuzu 18 Tonnes',
  description: 'Camion Isuzu FVR 34K 18 tonnes châssis court. Idéal charges lourdes et transport industriel. CADOZAT Maroc.',
  alternates: { canonical: 'https://cadozat.com/catalogue/fvr-34k' },
}
      ...
      <section className="bg-white pt-32 pb-16 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-8 flex-wrap">
            ...
            <span>/</span>
            <span className="text-[#CC0000] font-semibold">FVR 34K 18T</span>
          </div>
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg font-semibold mb-5">18T — Châssis court</p>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-1 bg-[#CC0000] rounded-full" />
                <div className="w-5 h-1 bg-[#C9A84C] rounded-full" />
              </div>
              <p className="text-gray-500 text-base leading-relaxed mb-8 max-w-lg">
                Le FVR 34K est le camion 18 tonnes de la gamme F-Series Isuzu. Plus puissant que les FTR, il offre une capacité de charge accrue pour les applications lourdes et les transports industriels.
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <h2 className="text-3xl font-black text-gray-900">Photos du FVR 34K</h2>
              <div className="h-px w-10 bg-[#C9A84C]" />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {images.map((src, i) => (
              <div key={i} className="aspect-video rounded-2xl overflow-hidden border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all">
                <img src={src} alt={`FVR 34K — Photo ${i + 1}`} className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"/>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { code: 'PTAC', valeur: '18 000', label: 'Poids total' },
              { code: 'EMP',  valeur: '3 900', label: 'Empattement' },
              { code: 'CAR',  valeur: '4 870', label: 'Long. carossable' },
