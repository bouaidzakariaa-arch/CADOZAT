...
const specs = [
  {
    ...
    items: [
      ...
      { label: 'Poids à vide — Avant', valeur: '3 020 kg' },
      { label: 'Poids à vide — Arrière', valeur: '1 850 kg' },
      { label: 'Poids à vide — Total', valeur: '4 870 kg' },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'Capacité essieu avant', valeur: '7 100 kg' },
      { label: 'Capacité essieu arrière', valeur: '11 500 kg' },
      { label: 'Rapport de pont', valeur: '6.667' },
    ],
  },
  {
    categorie: 'Moteur',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Dimension pneus', valeur: '12R22.5-16' },
...
const dimensions = [
  ...
  { code: 'OH', valeur: '2 850', label: 'Hauteur totale' },
  { code: 'AW', valeur: '1 965', label: 'Voie avant' },
  { code: 'BW', valeur: '2 480', label: 'Voie arrière ext.' },
  { code: 'CW', valeur: '1 850', label: 'Voie arrière int.' },
  { code: 'EH', valeur: '1 140', label: 'Hauteur châssis' },
]
...
const modeles_fseries = [
  { nom: 'FVR 34K 18T', href: '/catalogue/fvr-34k', actif: true },
  { nom: 'FVR 34P 18T', href: '/catalogue/fvr-34p', actif: false },
]

export default function FVR34KPage() {
  return (
    <main className="bg-white">
      ...
      <section className="relative bg-[#1B2B6B] py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <span>/</span>
            <span className="text-[#C9A84C] font-semibold">FVR 34K 18T</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4 flex-wrap">
                ...
                <span className="bg-[#C9A84C] text-white text-xs font-bold px-3 py-1 rounded-full">18T</span>
                <span className="bg-white/10 text-white text-xs font-semibold px-3 py-1 rounded-full border border-white/20">Châssis court</span>
              </div>
              <h1 className="text-5xl lg:text-6xl font-black text-white mb-1">
                FVR <span className="text-[#CC0000]">34K</span>
              </h1>
              <p className="text-white/50 text-lg font-semibold mb-4">18T — Châssis court</p>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-1 bg-[#CC0000] rounded-full"></div>
                <div className="w-6 h-1 bg-[#C9A84C] rounded-full"></div>
              </div>
              <p className="text-white/70 text-lg leading-relaxed mb-8">
                Le FVR 34K est un camion lourd 18T sur châssis court, conçu pour les transports
                sur longs parcours et les applications sévères. Cabine large et aérodynamique,
                moteur 6 cylindres 6HK1-TCN à haute puissance et couple extrême.
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3 mt-3">
              ...
              <h2 className="text-3xl font-black text-[#1B2B6B]">Photos du FVR 34K</h2>
              <div className="h-px w-12 bg-[#C9A84C]"></div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {dimensions.map((d, i) => (
              <div key={i} className="bg-white rounded-2xl border-2 border-gray-100 hover:border-[#CC0000]/30 p-5 text-center transition-all group">
      ...
      <BrochureForm modele="FVR34K" marque="isuzu" nomModele="FVR 34K" />
      {/* CTA */}
      <section className="py-16 bg-[#1B2B6B] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-white mb-2">
            Intéressé par le <span className="text-[#CC0000]">FVR 34K</span> ?
          </h2>
