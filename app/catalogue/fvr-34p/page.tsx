...
const specs = [
  {
    ...
    items: [
      ...
      { label: 'Poids à vide — Avant', valeur: '3 160 kg' },
      { label: 'Poids à vide — Arrière', valeur: '1 930 kg' },
      { label: 'Poids à vide — Total', valeur: '5 090 kg' },
    ],
  },
  {
...
const dimensions = [
  { code: 'OAL', valeur: '8 600', label: 'Longueur totale' },
  { code: 'WB', valeur: '5 050', label: 'Empattement' },
  { code: 'FOH', valeur: '1 440', label: 'Porte-à-faux avant' },
  { code: 'ROH', valeur: '2 110', label: 'Porte-à-faux arrière' },
  { code: 'CA', valeur: '4 424', label: 'Long. cabine-essieu' },
  { code: 'CE', valeur: '6 535', label: 'Longueur carossable' },
      ...
      <section className="relative bg-[#1B2B6B] py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <span>/</span>
            <span className="text-[#C9A84C] font-semibold">FVR 34P 18T</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4 flex-wrap">
                ...
                <span className="bg-white/10 text-white text-xs font-semibold px-3 py-1 rounded-full border border-white/20">Grand empattement</span>
              </div>
              <h1 className="text-5xl lg:text-6xl font-black text-white mb-1">
                FVR <span className="text-[#CC0000]">34P</span>
              </h1>
              <p className="text-white/50 text-lg font-semibold mb-4">18T — Grand empattement</p>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-1 bg-[#CC0000] rounded-full"></div>
                <div className="w-6 h-1 bg-[#C9A84C] rounded-full"></div>
              </div>
              <p className="text-white/70 text-lg leading-relaxed mb-8">
                Le FVR 34P est la version grand empattement du FVR 18T, offrant une longueur
                carossable de 6 600 mm pour les charges volumineuses. Même moteur 6 cylindres
                6HK1-TCN puissant, avec double réservoir 200+200 litres pour les longs trajets.
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: '⛽', label: 'Réservoir', valeur: '200 + 200 L' },
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3 mt-3">
              ...
              <h2 className="text-3xl font-black text-[#1B2B6B]">Photos du FVR 34P</h2>
              <div className="h-px w-12 bg-[#C9A84C]"></div>
            </div>
          </div>
