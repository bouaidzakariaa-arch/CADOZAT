...
const images = [
  ...
  '/images/camions/serie-n/nqr-90m/img3.jpg',
  '/images/camions/serie-n/nqr-90m/img4.jpg',
  '/images/camions/serie-n/nqr-90m/img5.jpg',
  '/images/camions/serie-n/nqr-90m/img6.jpg',
]
      ...
      <section className="bg-white pt-32 pb-16 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-8 flex-wrap">
            ...
            <span>/</span>
            <span className="text-[#CC0000] font-semibold">NQR 90M 9.5T</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg font-semibold mb-5">9.5T — Châssis long</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <h2 className="text-3xl font-black text-gray-900">Photos du NQR 90M</h2>
              <div className="h-px w-10 bg-[#C9A84C]" />
            </div>
          </div>
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-gray-900 mb-2">
            Intéressé par le <span className="text-[#CC0000]">NQR 90M</span> ?
          </h2>
