...
const specs = [
  {
    ...
    icon: '📐',
    items: [
      { label: "Empattement", valeur: "4 475 mm" },
      { label: "Longueur carossable", valeur: "6 132 mm" },
      { label: "PTAC", valeur: "9 500 kg" },
      { label: "Poids à vide — Avant", valeur: "1 920 kg" },
      { label: "Poids à vide — Arrière", valeur: "1 020 kg" },
      { label: "Poids à vide — Total", valeur: "2 960 kg" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Rapports", valeur: "6 AV + 1 AR" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Goujons", valeur: "6" },
      { label: "Réservoir", valeur: "140 litres" },
...
const dimensions = [
  { code: "OAL", valeur: "7 815", label: "Longueur totale" },
  { code: "WB", valeur: "4 475", label: "Empattement" },
  { code: "FOH", valeur: "1 110", label: "Porte-à-faux avant" },
  { code: "ROH", valeur: "2 230", label: "Porte-à-faux arrière" },
  { code: "CE", valeur: "6 132", label: "Longueur carossable" },
  { code: "CA", valeur: "3 902", label: "Longueur cabine" },
...
const modeles_nseries = [
  ...
  { nom: "NQR 90M", href: "/catalogue/nqr-90m", actif: true }
]
    ...
    <main className="bg-white">
      <section className="relative bg-[#1B2B6B] py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <Link href="/catalogue" className="hover:text-white transition-colors">Notre gamme</Link><span>/</span>
            <span className="text-white/60">N-Series</span><span>/</span>
            <span className="text-[#C9A84C] font-semibold">NQR 90M</span>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4 flex-wrap">
                ...
                <span className="bg-[#C9A84C] text-white text-xs font-bold px-3 py-1 rounded-full">9.5T</span>
              ...
              <h1 className="text-5xl lg:text-6xl font-black text-white mb-1">
                NQR <span className="text-[#CC0000]">90M</span>
              </h1>
              <p className="text-white/50 text-lg font-semibold mb-4">9.5T — Châssis long</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { icon: '⚡', label: 'Puissance', valeur: '190 ch (140 kw) / 2 600 tr/min' },
                { icon: '🔄', label: 'Couple maxi', valeur: '513 Nm / 1 600-2 600 tr/min' },
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3 mt-3">
              ...
              <h2 className="text-3xl font-black text-[#1B2B6B]">Photos du NQR 90M</h2>
              <div className="h-px w-12 bg-[#C9A84C]"></div>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {images.map((src, i) => (
              <div key={i} className="aspect-video rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all bg-gradient-to-br from-[#1B2B6B] to-[#CC0000]">
                <img src={src} alt={`NQR 90M — Photo ${i + 1}`} className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"/>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            {modeles_nseries.map((m) => (
              <Link key={m.nom} href={m.href} className={`px-5 py-2.5 rounded-full text-sm font-bold transition-all ${m.actif ? 'bg-[#CC0000] text-white shadow-md' : 'bg-white border-2 border-gray-200 text-gray-600 hover:border-[#CC0000] hover:text-[#CC0000]'}`}>{m.nom}</Link>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#1B2B6B] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-white mb-2">Intéressé par le <span className="text-[#CC0000]">NQR 90M</span> ?</h2>
