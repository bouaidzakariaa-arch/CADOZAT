...
export default function ReferencesClient() {
  return (
    <main style={{ minHeight: "100vh", background: "#f7f6f3", paddingTop: 80 }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative" as const }}>
          <div style={{
            ...
            letterSpacing: "0.15em", padding: "5px 16px", borderRadius: 20,
          ...
          <h1 style={{
            ...
            color: "#fff", marginBottom: "1rem", lineHeight: 1.1,
          }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "3rem", flexWrap: "wrap" as const }}>
            {[["9+", "Partenaires"], ["3", "Agences au Maroc"], ["25+", "Années d'expérience"]].map(([num, label], i) => (
              <div key={i} style={{ textAlign: "center" }}>
                ...
                <div style={{ fontSize: 12, color: "rgba(255,255,255,0.6)", marginTop: 5, fontWeight: 500 }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── CTA — même style que les autres pages ── */}
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{
            ...
            <h2 style={{
              ...
              Votre flotte a besoin de véhicules fiables ?
            </h2>
            <p style={{
              fontSize: 15, color: "rgba(255,255,255,0.65)",
              lineHeight: 1.7, maxWidth: 520, margin: "0 auto 2rem",
            }}>
              Atelier fixe ou mobile — notre équipe vous accompagne
              dans vos projets d'acquisition de véhicules utilitaires.
            </p>
            <div style={{
              display: "flex", gap: 12,
              ...
              <a href="tel:0524885025" style={{
                ...
                textDecoration: "none",
                boxShadow: "0 2px 14px rgba(204,0,0,0.4)",
